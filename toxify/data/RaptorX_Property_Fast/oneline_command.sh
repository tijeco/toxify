...
# ------- run ProtProp Server --------- #
Server_Root=$CurRoot
$Server_Root/util/Verify_FASTA $1 /tmp/$relnam.fasta
OUT=$?
if [ $OUT -ne 0 ]
then
	echo "failed in $Server_Root/util/Verify_FASTA $1 /tmp/$relnam.fasta"
	exit 1
fi
